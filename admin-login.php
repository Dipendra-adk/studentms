...
<html>
    ...
    <body>
        <form action="include/admin-login.php" method="POST" class="login">
            <header><i class="fas fa-user"></i></header>
            <div class="container">
            <div class="field"><span class="fa fa-user"></span><input type="email" placeholder="Email or Username" name="Email" reqired="true"></div>
